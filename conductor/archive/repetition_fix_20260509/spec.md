...
## Problem
The AI companion occasionally enters loops (repeating past replies) or echoes the user's input/prompts. This is caused by a lack of repetition penalty during the token generation phase.
